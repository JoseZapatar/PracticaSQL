...
insert into Estudiantes(ID_estudiante, IDUCA, Nombre, Apellido, FechaNac, Correo_electronico, Telefono, Carrera) 
values (006, N'000012568', N'Jorge', N'Torres', '02/12/1999', N'jtorres@est.uca.edu.ni', N'57322943', N'ISI')
go
...
insert into Estudiantes(ID_estudiante, IDUCA, Nombre, Apellido, FechaNac, Correo_electronico, Telefono, Carrera) 
values (005, N'000013456', N'Luca', N'Torres', '04/12/2002', N'lucato@est.uca.edu.ni', N'57829943', N'ISI')
go
...
insert into Estudiantes(ID_estudiante, IDUCA, Nombre, Apellido, FechaNac, Correo_electronico, Telefono, Carrera) 
values (013, N'000024684', N'Izumi', N'Redentor', '11/04/1995', N'izure@est.uca.edu.ni', N'85524511', N'CIVIL')
go
...
insert into Clases(ID_clase, Codigo_clase, Nombre_clase, Horario) values (002, N'B102', N'Taller de lectura Comprensiva', N'Martes 2 p.m')
go
...
insert into Clases(ID_clase, Codigo_clase, Nombre_clase, Horario) values (005, N'B105', N'Programación Orientada a Objetos', N'Viernes 4 p.m')
go

insert into Clases(ID_clase, Codigo_clase, Nombre_clase, Horario) values (006, N'B106', N'Calculo 1', N'Jueves 10 a.m')
go

insert into Clases(ID_clase, Codigo_clase, Nombre_clase, Horario) values (007, N'B107', N'Física', N'Jueves 11 a.m')
go
...
insert into Clases(ID_clase, Codigo_clase, Nombre_clase, Horario) values (010, N'B110', N'Biología', N'Miercoles 10 a.m')
go
